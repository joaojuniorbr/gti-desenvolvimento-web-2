...
<body class="bg-gray-100">
  <div class="max-w-md mx-auto py-10 px-6">
    ...
    ?>
      <div class="mt-10 bg-slate-50 border border-slate-200 rounded p-6">
        ...
        <p class="<?php echo $haveTroco ? 'text-green-600' : 'text-red-600'; ?>"><strong>Mensagem:</strong> <?php echo $mensagem; ?></p>
      </div>
    <?php endif; ?>
  </div>
</body>
